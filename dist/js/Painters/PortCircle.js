...
var PortCircle = /*#__PURE__*/function () {
  function PortCircle() {
    _classCallCheck(this, PortCircle);
  }

  _createClass(PortCircle, [{
    key: "drawPortsCore",
    value: // protected
    ...
    value: function draw(groups_entity) {
      var ports = groups_entity.selectAll('circle.entity-port').data(function (d) {
